<script>
  ...
  const projects = [
    { num: '01', title: 'Fakturo', sub: 'SaaS fakturační systém',
    ...
    { num: '02', title: 'CV Builder', sub: 'Interaktivní tvůrce CV',
    ...
    { num: '03', title: 'CyberBot', sub: 'AI asistent pro CTF & kybernetickou bezpečnost',
