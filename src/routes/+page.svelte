<script>
  ...
  const projects = [
    { num: '01', title: 'BotCraft', sub: 'SaaS AI Chatbot Builder s RAG',
      desc: 'Platforma pro tvorbu AI chatbotů s vlastní znalostní bází. Upload dokumentů (PDF/TXT/MD), vektorové vyhledávání, Groq LLM (Llama 3, DeepSeek R1), embed na libovolný web jedním skriptem.',
      tech: ['Next.js 14', 'Supabase pgvector', 'Groq AI', 'Clerk', 'Stripe'], color: '#6366f1',
      url: 'https://botcraft.vercel.app',
    },
    { num: '02', title: 'Fakturo', sub: 'SaaS fakturační systém',
      desc: 'Profesionální fakturace pro freelancery a malé firmy. Tvorba faktur, PDF export, CZK/EUR/USD, DPH, správa klientů. Stripe platby, Free & Pro plán.',
      tech: ['Next.js 14', 'Supabase', 'Stripe', 'Clerk'], color: '#4f46e5',
      url: 'https://fakturo-seven.vercel.app',
    },
    ...
    { num: '04', title: 'CyberBot', sub: 'AI asistent pro CTF & kybernetickou bezpečnost',
      desc: 'AI chatbot zaměřený na CTF soutěže a kybernetickou bezpečnost. Analyzuje výstupy nástrojů (nmap, gobuster), pomáhá s privilege escalation, reverse shells a CTF metodologií.',
  ...
  const skills = [
    ...
    { name: 'Supabase / SQL',     pct: 72 },
    { name: 'GSAP / Three.js',    pct: 70 },
